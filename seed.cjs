...
const defaultPlans = [
  {
    ...
    features: JSON.stringify({
      ...
      proxies: 1, customProxies: 0, gcpProjects: 1, _enforce_gcpProjects: true,
      _enforce_dailySearches: true, _enforce_proxies: true,
      autoRefill: true, scheduledUpload: true,
  ...
  },
  {
    ...
    features: JSON.stringify({
      ...
      proxies: 3, customProxies: 2, gcpProjects: 3, _enforce_gcpProjects: true,
      _enforce_dailySearches: true, _enforce_proxies: true,
      autoRefill: true, scheduledUpload: true,
  ...
  },
  {
    ...
    features: JSON.stringify({
      ...
      proxies: 10, customProxies: 10, gcpProjects: 10, _enforce_gcpProjects: true,
      _enforce_dailySearches: true, _enforce_proxies: true,
      autoRefill: true, scheduledUpload: true,
  ...
  },
  {
    ...
    features: JSON.stringify({
      ...
      proxies: 999999, customProxies: 999999, gcpProjects: 999999,
      autoRefill: true, scheduledUpload: true,
