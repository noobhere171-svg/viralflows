        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <Step num={1} title="Open Google Cloud Console">
              <a href="https://console.cloud.google.com" target="_blank" rel="noopener noreferrer"
                className="text-violet-400 underline inline-flex items-center gap-1 hover:text-violet-300">
            ...
            <Step num={6} title="Add Authorized JavaScript Origins">
              ...
              <div className="flex items-center gap-2 bg-[#0f0f0f] border border-[#2a2a2a] rounded-lg px-3 py-2 max-w-full">
                <code className="text-xs text-violet-300 flex-1 min-w-0 truncate">{JS_ORIGIN}</code>
                <button onClick={() => handleCopy(JS_ORIGIN, setCopiedOrigin)}
                  className="text-[10px] bg-violet-500/10 text-violet-400 hover:bg-violet-500/20 px-2 py-1 rounded flex items-center gap-1 shrink-0">
            ...
            <Step num={7} title="Add Authorized Redirect URIs">
              ...
              <div className="flex items-center gap-2 bg-[#0f0f0f] border border-[#2a2a2a] rounded-lg px-3 py-2 max-w-full">
                <code className="text-xs text-violet-300 flex-1 min-w-0 truncate">{REDIRECT_URI}</code>
            ...
            <Step num={8} title="Download the JSON File">
              ...
              <br />Save the <code className="text-violet-300 bg-[#0f0f0f] px-1 rounded">client_secret.json</code> file to your computer
            </Step>
            ...
            <Step num={9} title="Upload to ViralFlows">
              ...
              <br />Click <strong className="text-zinc-300">Upload</strong> → Select the downloaded <code className="text-violet-300 bg-[#0f0f0f] px-1 rounded">.json</code> file
          ...
          <div className="mt-5 pt-4 border-t border-[#2a2a2a]">
            <button onClick={() => { setShowGcpGuide(false); navigate("/workspaces"); }}
              className="w-full bg-violet-600 hover:bg-violet-700 text-white text-sm font-medium py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2">
